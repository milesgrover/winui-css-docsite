...
export const lightValues = {
    ...
    SolidBackgroundFillColorBase: "rgba(243, 243, 243, 1)",
    SolidBackgroundFillColorSecondary: "rgba(238, 238, 238, 1)",
    SolidBackgroundFillColorTertiary: "rgba(249, 249, 249, 1)",
    SolidBackgroundFillColorQuarternary: "rgba(255, 255, 255, 1)",
    SolidBackgroundFillColorTransparent: "rgba(243, 243, 243, 0)",
    
    SystemFillColorSuccess: "rgba(15, 123, 15, 1)",
    SystemFillColorCaution: "rgba(157, 93, 0, 1)",
    SystemFillColorCritical: "rgba(196, 43, 28, 1)",
    SystemFillColorNeutral: "rgba(0, 0, 0, 0.4458)",
    SystemFillColorSolidNeutral: "rgba(138, 138, 138, 1)",
    SystemFillColorAttentionBackground: "rgba(246, 246, 246, 0.5)",
    SystemFillColorSuccessBackground: "rgba(223, 246, 221, 1)",
    SystemFillColorCautionBackground: "rgba(255, 244, 206, 1)",
    SystemFillColorCriticalBackground: "rgba(253, 231, 233, 1)",
    SystemFillColorNeutralBackground: "rgba(0, 0, 0, 0.0241)",
    SystemFillColorSolidAttentionBackground: "rgba(247, 247, 247, 1)",
    SystemFillColorSolidNeutralBackground: "rgba(243, 243, 243, 1)",
}
...
export const darkValues = {
    ...
    SolidBackgroundFillColorBase: "rgba(32, 32, 32, 1)",
    SolidBackgroundFillColorSecondary: "rgba(28, 28, 28, 1)",
    SolidBackgroundFillColorTertiary: "rgba(40, 40, 40, 1)",
    SolidBackgroundFillColorQuarternary: "rgba(44, 44, 44, 1)",
    SolidBackgroundFillColorTransparent: "rgba(32, 32, 32, 0)",
    
    SystemFillColorSuccess: "rgba(108, 203, 95, 1)",
    SystemFillColorCaution: "rgba(252, 225, 0, 1)",
    SystemFillColorCritical: "rgba(255, 153, 164, 1)",
    SystemFillColorNeutral: "rgba(255, 255, 255, 0.5442)",
    SystemFillColorSolidNeutral: "rgba(157, 157, 157, 1)",
    SystemFillColorAttentionBackground: "rgba(255, 255, 255, 0.0326)",
    SystemFillColorSuccessBackground: "rgba(57, 61, 27, 1)",
    SystemFillColorCautionBackground: "rgba(67, 53, 25, 1)",
    SystemFillColorCriticalBackground: "rgba(68, 39, 38, 1)",
    SystemFillColorNeutralBackground: "rgba(255, 255, 255, 0.0326)",
    SystemFillColorSolidAttentionBackground: "rgba(46, 46, 46, 1)",
    SystemFillColorSolidNeutralBackground: "rgba(46, 46, 46, 1)",
}